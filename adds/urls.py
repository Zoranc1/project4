...
from .views import read_ad, edit_ad, write_ad, get_unpublished_ad, publish_ad,show_all_ads, ad_category
...
urlpatterns = [
    ...
    path('category/<category>', ad_category, name='ads_by_category'),
